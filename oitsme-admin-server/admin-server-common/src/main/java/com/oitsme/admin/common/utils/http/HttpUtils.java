package com.oitsme.admin.common.utils.http;

import com.oitsme.admin.common.utils.MyX509TrustManager;
...
/**
 * @Author: pinro
 * @Package_name: com.oitsme.cloud.common.utils.http
...
public class HttpUtils {
    ...
    public static String get(String url, Map<String, String> params,
        ...
        if (isHttps(url)) {
            http = initHttps(initParams(url, params), METHOD_GET, headers);
        } else {
            http = initHttp(initParams(url, params), METHOD_GET, headers);
        }
    ...
    public static String post(String url, String params)
        ...
        HttpURLConnection http = null;
        if (isHttps(url)) {
            http = initHttps(url, METHOD_POST, null);
        } else {
            http = initHttp(url, METHOD_POST, null);
        }
